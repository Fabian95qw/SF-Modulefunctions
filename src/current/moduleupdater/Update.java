...
@Function(name="Moduleupdater.Update", visibility=Visibility.Private, description="HTTP(S) GET a Metafile and Updates for any module")
public class Update implements IBaseExecutable 
{
	...
	public void execute(IRuntimeEnvironment context) throws Exception 
	{
		...
		{
			Starface_Version = context.springApplicationContext().getBean("pbxVersion", String.class);
		}
