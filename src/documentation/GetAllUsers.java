...
public class GetAllUsers implements IBaseExecutable 
{
	...
	public void execute(IRuntimeEnvironment context) throws Exception 
	{
		...
		for(ExtendedUserData EUD : UBO.getUsers())
		{
			...
			String MainExtPhoneNumber = CAT.getPrimaryExternPhoneNumberForAccount(EUD.getAccountId());
			String MainIntPhoneNumber = CAT.getPrimaryInternPhoneNumberForAccount(EUD.getAccountId());
			String DisplayNumber = CAT.getDisplayNumberForAccountId(EUD.getAccountId(), true);			
